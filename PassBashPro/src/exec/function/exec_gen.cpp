...
static const int DEFAULT_LENGTH_MIN = 6;
static const int DEFAULT_LENGTH_MAX = 12;
...
static const char ALPHA_SET[] = "AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz";
static const char DIGIT_SET[] = "0123456789";
static const char CHARA_SET[] = "~!@#$%^&*()[]{}-_=+";
...
static std::string _generate_password()
{
	...
	for (int i = 0; i < length; i++)
		password.push_back(candidates[Random((int)candidates.length())]);
