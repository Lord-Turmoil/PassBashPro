...
int _set_key(const char* idStr, const char* newKey)
{
    ...
    _ShowItemSimple(_edit_item, false, newKey, ENTRY_MODIFY_COLOR);
...
int _set_value(const char* idStr, const char* value)
{
    ...
    _ShowItemSimple(_edit_item, false, entry->Attribute("key"), ENTRY_MODIFY_COLOR);
...
int _set_entry(const char* key, const char* value, const char* weightStr)
{
    ...
    _ShowItemSimple(_edit_item, false, key, ENTRY_MODIFY_COLOR);
